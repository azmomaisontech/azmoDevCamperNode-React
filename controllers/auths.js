...
exports.loginUser = asyncHandler(async (req, res, next) => {
  ...
  if (!email || !password) return next(new ErrorResponse(`Please enter email and password`, 404));
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  if (!user) return next(new ErrorResponse("User does not exist with this email", 404));
